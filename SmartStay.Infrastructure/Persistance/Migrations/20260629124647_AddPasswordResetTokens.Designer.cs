...
namespace SmartStay.Infrastructure.Persistance.Migrations
{
    ...
    [Migration("20260629124647_AddPasswordResetTokens")]
            ...
            modelBuilder.Entity("SmartStay.Domain.Entities.Amenity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("64ff4bbb-e98d-46a7-ba17-48db9e46745f"),
                            Name = "Pool"
                        },
                        new
                        {
                            Id = new Guid("b85d64b7-fe63-4a61-9378-53e933b392ad"),
                            Name = "Garage"
                        },
                        new
                        {
                            Id = new Guid("8d9f9fd3-779b-4f0a-bca1-d23f3cc46d1b"),
                            Name = "Gym"
                        },
                        new
                        {
                            Id = new Guid("6ebfc71e-5ab8-4b5c-b340-05b143a49082"),
                            Name = "Spa"
                        },
                        new
                        {
                        ...
                        new
                        {
                            Id = new Guid("d659ae8a-1743-4568-8d48-dd81ef609271"),
                            Name = "Breakfast"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("SmartStay.Domain.Entities.Room", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BedType = "King",
                            Capacity = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 6, 29, 12, 46, 47, 19, DateTimeKind.Unspecified).AddTicks(4143), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            BedType = "Queen",
                            Capacity = 4,
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 6, 29, 12, 46, 47, 19, DateTimeKind.Unspecified).AddTicks(4553), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            BedType = "Single",
                            Capacity = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 6, 29, 12, 46, 47, 19, DateTimeKind.Unspecified).AddTicks(4593), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            BedType = "King",
                            Capacity = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 6, 29, 12, 46, 47, 19, DateTimeKind.Unspecified).AddTicks(4597), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            BedType = "Single",
                            Capacity = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 6, 29, 12, 46, 47, 19, DateTimeKind.Unspecified).AddTicks(4600), new TimeSpan(0, 0, 0, 0, 0)),
