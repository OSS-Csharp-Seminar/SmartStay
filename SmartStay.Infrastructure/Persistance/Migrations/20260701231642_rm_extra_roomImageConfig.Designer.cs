...
namespace SmartStay.Infrastructure.Persistance.Migrations
{
    ...
    [Migration("20260701231642_rm_extra_roomImageConfig")]
    partial class rm_extra_roomImageConfig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmartStay.Domain.Entities.Amenity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("1df3c9a0-4d10-4e3f-8bc7-43fbdc9de977"),
                            Name = "Pool"
                        },
                        new
                        {
                            Id = new Guid("7082abab-bdaf-4173-953b-91e06651b430"),
                            Name = "Garage"
                        },
                        new
                        {
                            Id = new Guid("d0c0b55f-5eab-409a-8744-a8523c9e08f1"),
                            Name = "Gym"
                        },
                        new
                        {
                            Id = new Guid("4694f994-bffc-4167-8ba6-1ac1784a387f"),
                            Name = "Spa"
                        },
                        new
                        {
                        ...
                        new
                        {
                            Id = new Guid("5f20e234-8d08-43df-979f-ad9af6bb80f4"),
                            Name = "Breakfast"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("SmartStay.Domain.Entities.Room", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BedType = "King",
                            Capacity = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 7, 1, 23, 16, 41, 249, DateTimeKind.Unspecified).AddTicks(1227), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            BedType = "Queen",
                            Capacity = 4,
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 7, 1, 23, 16, 41, 249, DateTimeKind.Unspecified).AddTicks(2679), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            BedType = "Single",
                            Capacity = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 7, 1, 23, 16, 41, 249, DateTimeKind.Unspecified).AddTicks(2697), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            BedType = "King",
                            Capacity = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 7, 1, 23, 16, 41, 249, DateTimeKind.Unspecified).AddTicks(2706), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            BedType = "Single",
                            Capacity = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 7, 1, 23, 16, 41, 249, DateTimeKind.Unspecified).AddTicks(2714), new TimeSpan(0, 0, 0, 0, 0)),
